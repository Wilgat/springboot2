...
**Updated:** 2026-07-20 (Type O-P payload-online-install requirement; install/uninstall vs self-*; INC-20260720-001)
...
| requirement-shell-cli-zero-arguments | Empty argv Type O-P combined ensure (ship unit + payload) | shell | Active | `requirement-shell-cli-zero-arguments.md` | 2026-07-20 |
...
| requirement-shell-payload-online-install | Type O-P payload online installer (combined ensure; install/uninstall vs self-*) | shell | Active | `requirement-shell-payload-online-install.md` | 2026-07-20 |
