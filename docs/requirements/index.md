...
**Updated:** 2026-07-24 (Design-time verification TP rows on all shell REQs; TP labels in `tests/`)
...
| requirement-springboot2-domain | Spring Boot payload content (SDKMAN/Java/Maven/Boot 2.7.18, project preserve, build/run) | domain | Active | `requirement-springboot2-domain.md` | 2026-07-20 |
