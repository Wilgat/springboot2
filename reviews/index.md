# Review reports index — springboot2
...
|----------|-------------:|--------|
| bug | 0 | — |
| suggestion | 0 | closed this turn (class, domain name, TP-MOD, README) |
| nit | 0 | — |
| watch lessons | 8 | silent pipe, O-P, payload layer, csum regen, downgrade, HOME, preserve, help |
